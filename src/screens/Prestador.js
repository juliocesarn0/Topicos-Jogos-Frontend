...
function AdicionaPrestador({ navigation, theme, route }) {
   ...
   const registroInicial = route.params ? route.params.prestador
                                        : {cnpj: '',razao_social: '',nome_fantasia: '',cnae_fiscal: '',data_inicio_atividade: hoje}
        ...
        <View style={{flex:1, paddingVertical: 0, paddingHorizontal: 0}}>
            ...
            paddingVertical: 4}}>
                ...
                <TextInput
                     ...
                     />
                <Text style={{color: colors.text, paddingLeft: 8}}>Razão Social</Text>     
                <TextInput
                    name="razao_social"
                    style={{margin:8}}     
                    ...
                    />
                <Text style={{color: colors.text, paddingLeft: 8}}>Nome Fantasia</Text>     
                <TextInput
                    name="nome_fantasia"
                    style={{margin:8}}     
                    keyboardType="default"
                ...
                <TextInput
                    ...
                    /> 
                <Text style={{color: colors.text, paddingLeft: 8}}>Início da Atividade</Text>     
                <TextInput
                    ...
                    onChangeText={(text)=> setPrestador({...prestador, 
